			...
			<div class="right_col" role="main">
				...
				<div class="row tile_count">
					<div
						...
						<div class="right">
							<span class="count_top"><i class="fa fa-user"></i> Total
								Users</span>
							<div class="count">${dto.totalUser}</div>
					...
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-user"></i> Online
								Users</span>
							<div class="count">${dto.onlineUser}</div>
							<!-- <span class="count_bottom"><i class="green">4% </i> From
								last Week</span> -->
						</div>
					</div>
					<div
						...
						<div class="right">
							<span class="count_top"><i class="fa fa-clock-o"></i>
								Today Transaction</span>
							<div class="count">${dto.todayTransaction}</div>
					...
					<div
						...
						<div class="right">
							<span class="count_top"><i class="fa fa-user"></i> Total
								Month Transaction</span>
							<div class="count green">${dto.totalTransactionCount}</div>
							<span class="count_bottom"><i class="green"> <!-- <i
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										PayQwik Transaction's <small> <!-- Graph title sub-title -->
										</small>
									</h3>
								</div>
								<!-- 	<div class="col-md-6">
