									...
									<table id="datatable"
										...
										<tbody>
											<c:forEach items="${userList}" var="users">
												<tr>
													<td><b>User Name : </b>${users.userDetail.firstName}
														${users.userDetail.middleName}
														${users.userDetail.lastName}<br /> <b>Mobile Number :</b>
														<a href='<spring:url value="/Admin/User/${users.userDetail.contactNo}" />'>${users.userDetail.contactNo}</a><br />
														<b>Email ID :</b> ${users.userDetail.email}</td>
													<td>${users.emailStatus}</td>
