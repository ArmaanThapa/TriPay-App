						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									...
									<!-- TODO AJAY -->
									<form method="post"
										action="${pageContext.request.contextPath}/Admin/Daily">
									...
									<ul class="nav navbar-right panel_toolbox">
										...
										<form method="post"
											...
											<c:forEach items="${pQTransaction}" var="contact"
												...
												<input name="transactions[${status.index}].status"
													value="${contact.status}" hidden="hidden" />
													<input name="transactions[${status.index}].description"
													value="${contact.description}" hidden="hidden" />
											</c:forEach>
                        ...
                        <li><a href="#">Settings 2</a>
								...
								<div class="x_content">
									...
									<table id="datatable"
										...
										<tbody id="userList">
											<c:forEach items="${pQTransaction}" var="messageLog">
												<tr>
													<td>${messageLog.created}</td>
													<td>${messageLog.amount}</td>
													<td>${messageLog.currentBalance}</td>
													<td>${messageLog.status}</td>
