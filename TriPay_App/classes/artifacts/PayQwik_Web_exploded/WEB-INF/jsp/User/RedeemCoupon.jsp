		...
		<div class="row">
			<div class="col-md-4" id="Prepaid">
				...
				<ul class="nav nav-pills">
					<li class="active"><a data-toggle="pill" href="#home">Redeem Coupon</a></li>
				</ul>

				<div class="tab-content" id="sendmoney">
					<div id="home" class="tab-pane fade in active">
						<form method="post"
							action="${pageContext.request.contextPath}/User/RedeemCoupon/Process">
							<div class="group_1">
				<input type="text" name="couponNumber"
					value="${coupon.couponNumber}"  required="required" maxlength="4"
					required />
								<span class="highlight"></span> <span class="bar"></span>
								<p class="error">${error.couponNumber}</p>
							...
							<button type="submit" class="btn"
								style="width: 80%; background: #ff0000; margin-top: 10px; color: #FFFFFF;">Redeem</button>
						</form>
					</div>
